...
The UK Graduate School has a parental leave policy for graduate students. [Link to Graduate School parental leave policy](https://gradschool.uky.edu/assistantships#Parental%20Leave)
...
A limited number of teaching positions are available through the Linguistics department each year. Students interested in applying to teach a summer course should apply via the Summer Teaching request form. Applications will be assessed by the Admissions and Awards committee and will be evaluated in terms of teaching qualifications (students must be eligible to teach a course as instructor of record), previous teaching performance, and seniority in the program.
...
Given the yearly variation in both the amount of available funding and student requests for the funds, funding is competitive and not guaranteed. The Graduate School provides the College with limited "Block" funds which our department chooses to use to fund graduate student research and travel. These moneys are available on a first-come-first-served basis and students should apply using the Research and Travel funding request form. These applications will be evaluated by the admissions and awards committee. Funding may be used for research (e.g. participant fees) or conference travel.
...
### What the DGS can expect from the PhD student
...
### What the PhD student can expect from their DGS
...
- Will conduct ongoing review meetings with students and provide annual, written feedback and assessment of each student's progress toward the degree.

## Advising expectations during doctoral candidacy
