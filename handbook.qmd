...
XXX We need a policy on summer support.
...
XXX There should be some text here about research funding available to graduate students.

### Conference Supplemental Funding

The Department works to provide graduate students with a supplement to attend conferences outside of Lexington. This supplement is designed to help (but not fully) cover costs related to travel, lodging and registration. Given the yearly variation in both the funds amounts and student requests for the funds, funding to all students is not guaranteed. This funding works under the following rules:
...
XXX text about how Institute funding works goes here.
...
- Understanding that it depends on the student/project, would you describe your typical style of advising as fitting into any of the categories in the Advising Chart (section 5.4.2)?
...
The examples in the following table, adapted from @davis2005, are borrowed from the UK Philosophy \& Mathematics graduate handbooks.
