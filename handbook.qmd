...
subtitle: "Revised: Fall 2026^[Find the most recent official version of this document on the [UK Linguistics Graduate Programs](https://linguistics.as.uky.edu/ling-grad-program) page]"
date: "12 August 2026"
...
The Department of Linguistics offers a graduate program leading to the degree of Doctor of Philosophy (PhD). For UK undergraduates, the department also participates in the AMP 4 + 1 program leading to the Master of Arts (MA) degree. Financial support for doctoral students is available in the form of [Teaching Assistantships, Research Assistantships](https://gradschool.uky.edu/funding/assistantships), and Journal Fellowships; these are awarded on a competitive basis. As a rule, the Department does not admit doctoral students without funding. For admitted students, full details of your financial support can be found in the offer letter you received when you were admitted to the program. This handbook contains policies regarding graduate study in the Department of Linguistics^[When in doubt, consult with the DGS]. Additional recommendations and guidance for students can be found on the Linguistics graduate program website: [https://linguistics.as.uky.edu/ling-grad-program](https://linguistics.as.uky.edu/ling-grad-program) and in the University-wide Graduate Catalog^[[University of Kentucky Graduate Catalog](http://catalogs.uky.edu/index.php)] (formerly the "Graduate Bulletin").
...
- UK Graduate School DGS Policies and Procedures Manual (note: outdated but still official): [https://gradschool.uky.edu/dgs-and-dgc-resources](https://gradschool.uky.edu/dgs-and-dgc-resources)
...
- Student Rights \& Responsibilities: [[https://studentsuccess.uky.edu/dean-students/student-rights-and-university-policies](https://studentsuccess.uky.edu/dean-students/student-rights-and-university-policies)]https://studentsuccess.uky.edu/student-conduct/services/student-rights-responsibilities-uk](https://studentsuccess.uky.edu/student-conduct/services/student-rights-responsibilities-uk)
- Available services for students (e.g. Food security, Emergency Housing, Financial Aid, Fitness, etc.): [https://studentsuccess.uky.edu/find-services](https://studentsuccess.uky.edu/find-services)
- Student Conduct: [https://studentsuccess.uky.edu/student-conduct](https://studentsuccess.uky.edu/student-conduct)
- UK Office of the Ombudsman: [https://www.uky.edu/ombud/](https://www.uky.edu/ombud/)
- Responding to Harassment \& Discrimination:
[https://oeo.uky.edu/key-priorities/discrimination-and-harassment](https://oeo.uky.edu/key-priorities/discrimination-and-harassment)
- Resources for Mental Health: [https://pres.uky.edu/mental-health-resources](https://pres.uky.edu/mental-health-resources)

## Academic Load

A graduate satisfactorily completing at least 9 credit hours or more in a semester is considered to be full-time.  Students enrolled in LIN 748 (0 credit hours, AMP students only), LIN 757 (2 credit hours, doctoral students preparing to defend QP), or LIN 767 (2 credit hours, doctoral students who have reached candidacy) are also classified as full-time.

Full-time students who fall below the minimum full-time equivalent as the result of dropping one or more courses are classified as part-time students for that semester. Note that international students may be in violation of their visa conditions if they do not maintain full-time status. Exceptions to this rule are managed by the Office of Academic Administration and the International Center.

Assistantship assignments entail up to 20 hours of work per week. A student with an assistantship **may not exceed twelve credit hours**  academic load without approval of the Graduate School. Anyone with an assistantship who wishes to take on an additional employment within the university should carefully read the policy and complete the overload request form both of which are available from the [Graduate School's Assistantship page under 'Additional Employment'](https://gradschool.uky.edu/funding/assistantships).

## Independent Study Credit
While it is sometimes appropriate to take an independent study course (LIN 695, with faculty-specific section numbers), we ask students to first look for scheduled graduate seminars.  This policy exists for two reasons: First, seminars with low enrollment may be cancelled. More importantly, graduate education is about learning beyond the very narrow confines of a thesis or dissertation. Your ability to teach across broad topics and situate your work in the discipline can be crucial in academic job hunting and career success. Your ability to engage deeply and successfully with topics that did not initially interest you can be crucial in a non-academic career.

Students interested in pursuing an independent study for course credit should begin by approaching an appropriate faculty member with a specific project in mind. The student and faculty member will work together to design an independent study course (with meeting times, expectations, and expected outcomes). An override to register for that faculty member's specific section of LIN 695 can be provided by the Department Manager.
...
A limited number of teaching positions are available each summer through the Linguistics department each year to teach online versions of either Lin 211 (Introduction to Linguistics) or Lin 200 (How to Create your own Language.) These courses take place virtually, mainly via-Canvas and video resources, and run either during the Summer Session first half (mid-May - early-July) or second half (mid-June - early-August, dates vary annually). The student will be listed as instructor of record.
...
- **Instructor Of Record Experience Needed**: preference given to students who have *not* yet had the opportunity to be instructor of record in a course.  We know this may feel backwards, but part of the motivation for offering summer courses like these is so that graduate students can have the experience of teaching as the primary instructor of a course and list that experience on their CV.
- **LIN experience**: people who have not had the opportunity to teach an LIN course will be given preference over people who have.  Again, this is about ensuring as many students as possible graduate with LIN teaching experience as a primary instructor.
- **Teaching Assessments**: Any teaching assessments/feedback from TA coordinator/previous instructors of record.
...
- **Good Standing**: preference given to students who are in good standing and making progress toward their degree.
...
When faculty members retire or leave the University, they may continue their service on previously established doctoral Advisory Committees but cannot be appointed to new committees. Requests to continue service should be made by the DGS to the A&S Associate Dean for Graduate Education, and include the names of all students affected.
...
Students will demonstrate knowledge of two languages beyond their primary language (i.e. the language used in the majority of your education prior to attending UK). The student’s advisor and/or DGS will determine the details regarding which specific languages and the manner of demonstrating the student’s knowledge of those languages. Examples of evidence of knowledge include but are not limited to:

- Undergraduate/MA coursework in the language which is equivalent to or demonstrates competence at or beyond the 4th semester (e.g. two full years of coursework) level
- Taking a course (at UK or otherwise) delivered primarily in the target language
- Conducting original research on the target language (e.g. an undergraduate thesis on nasalization in Malayalam, an MA thesis on A-Bar movement in Japanese, or fieldwork conducted with speakers of Chatino would each satisfy the requirement if the subject language is not the student's primary language )
- Language proficiency scores (e.g. ACTFL, CLE, ASLPI, IETLS, etc.), including those used for admission to UK if the student's primary language is not English, may be used. The necessary score/proficiency level depends on the test and can be determined on a case-by-case basis in consultation with the student's advisor and/or the DGS
...
A unanimous vote is required to pass this examination. If the committee vote is a tie, the candidate fails that attempt. If the result is failure, the advisory committee determines the conditions to be met before another examination may be given. The minimum time between examinations is four months. A second examination must be taken within one year after taking the first examination; a third examination is not permitted. If a student fails the qualifying examination on the first attempt, the Advisory Committee can not be changed prior to re-examination without approval of the Associate Dean for Graduate Education of the College of Arts & Sciences. Students are admitted to candidacy for the doctoral degree after they have successfully completed the Qualifying Examination and coursework (see @sec-timeline); the date is noted on the student's transcript.

## Dissertation Prospectus

The principal goal of the prospectus is to communicate clearly to the dissertation committee one's proposed dissertation research; its goals, scope, and methods. It usually begins with a discussion of the central issue or problem, interwoven with a critical review of the relevant scholarship to date in the area. The prospectus should include an outline of data collection procedures and other methodological issues, as well as a demonstration — usually via some preliminary analysis — that the proposed study will be able to deliver answers to the research questions. 
...
# Accelerated Master's Pathways (AMP) Program

## Introduction

The [University of Kentucky’s Accelerated Master’s Pathways (AMP)](https://gradschool.uky.edu/accelerated-masters-pathways-amp) gives highly-motivated students the opportunity to earn a master’s degree in one additional year of graduate study (4 + 1). Qualified students can begin earning graduate credit during their undergraduate program, earning up to 12 graduate credit hours at undergraduate tuition prices. The Master’s in Linguistics offers AMP students training in theoretical frameworks for approaching descriptive and sociolinguistic data with related emphases on historical, corpus, and computational linguistics. In addition to providing preparation for doctoral studies in linguistics, the MA program prepares students for careers in industry, consultancies in law and medicine, jobs in government agencies, etc.

The purpose of the MA degree is to provide students with the knowledge, skills, and experience necessary to conduct independent research and to demonstrate that ability to employers or doctoral programs. In addition, the MA program is designed to enable students, to pursue a substantive area of scholarship at a depth not possible at the undergraduate level alone.

The MA degree does not admit students directly but is available to Kentucky undergraduates through the AMP program. The MA degree can also be awarded to students enrolled in the doctoral program who have completed the requirements for candidacy but who will not continue in the doctoral program.

## Advisor and Thesis Committee

MA students are strongly encouraged to identify a potential advisor prior to their graduate year. Once a student and advisor have agreed to work with each other (see section 6.4XXX is section correct?), this information should be communicated to the DGS in written or email form. For the MA, a three-member Thesis Committee will generally be convened no later than Fall of the graduate year for the purpose of guiding the student in the development and completion, writing, and public defense of an independent research project In every case, at least two members of the Committee should be Linguistics faculty members. At least one member of the Advisory Committee must hold Full Graduate Faculty status (generally limited to associate and full professors).

## Coursework Requirements

Earning an MA in Linguistics at the University of Kentucky requires the successful completion of 30 total hours of coursework including the following core courses. Up to 12 credit hours can be taken as both undergraduate and graduate; student must have declared an interest in AMP status by the time the courses were taken as courses can not be retroactively converted to graduate credit.

- LIN 601 - Qualitative Research Methods in Linguistics
- LIN 701 - Research Seminar in Linguistics (Lin 611 is the standard alternative if this course is not offered)
...
Until you form a committee and choose an advisor--something that typically happens in your second year--the Director of Graduate Studies (DGS) serves as your temporary academic advisor.

In practice, this means that for the initial semesters of the program, students typically work mainly with the DGS, but are strongly encouraged to pursue advising from a range of faculty members--both to benefit from a wider variety of guidance and as an opportunity to seek out the best fit for your academic and interpersonal needs. The DGS helps ensure that you are satisfying degree requirements and helps you navigate coursework, assistantships, identifying funding sources, etc. but will likely not be deeply familiar with your research.

As you form relationships with faculty members who are likely to serve on your dissertation committee, there is a natural transition that takes place, with more guidance coming from those faculty members. However, the DGS always remains available as a resource for students at any stage of the program. After you have recruited a thesis/dissertation advising committee, your academic advisor will serve as the chair or co-chair of that committee.
...
Despite this, faculty members, including the DGS, are usually able and willing to stay in contact electronically over the summer, even if it may sometimes take longer to hear back. It is always ok to send a follow-up email. If your advisor is going to be fully out of contact for an extended period—even over the summer--it is reasonable to expect that they will let you know ahead of time.

The requirements for your degree program, and procedures for satisfying those requirements, are outlined in two documents: this document and the Graduate School’s Graduate Catalog^[[Current Graduate Catalog](https://catalogs.uky.edu/)].

You should take time to read over both of these documents.

This UK Linguistics Graduate Handbook describes the requirements of the Linguistic Department’s programs specifically--including coursework requirements, the definition of “adequate progress,” and other program requirements such as the MA Thesis or the PhD Qualifying Exam, Dissertation Prospectus, and Final Defense.
...
The Director of Graduate Studies (DGS) is the local representative of the Linguistics department graduate degree programs to the University of Kentucky graduate school. The DGS is responsible for the recruitment, admission, advising, and examining of students in the program. The DGS is a member of the Linguistics faculty who has been appointed by the Associate Dean for Graduate Education for the College of Arts & Sciences after consultation with Linguistics graduate faculty. The standard term for a DGS is typically three years.
...
- Maintain familiarity with both the Grad Regs and the Catalog
- Maintain a courteous, professional relationship with Linguistics Department Manager
...
4. If that doesn’t help (enough), or if you are uncomfortable going to the Chair, request a meeting with the College of A&S Associate Dean of Graduate Studies. Currently, the acting Dean of Graduate Studies is Professor Allison Burkette You can check the Dean's Office page at the College of A&S website^[[https://www.as.uky.edu/deans-office](https://www.as.uky.edu/deans-office)] for information on how to schedule an appointment. Scroll down until you find the Associate Dean of Graduate Studies.
...
- [ ] Advisor engaged by end of 3^rd^ or 4^th^ semester and registered with the DGS
- [ ] Demonstrate knowledge of two languages beyond your primary language.
- [ ] Committee formed (by 5^th^ semester) and The Formation of Doctoral Advisory Committee Form is submitted to the Graduate School^[[gradschool.uky.edu/studentforms](https://gradschool.uky.edu/studentforms)]
...
- [ ] Complete qualifying exam (by Fall of 3^rd^ year)
