...
subtitle: "Spring 2024^[Find the most recent revision of this document on the [UK Linguistics Graduate Programs](https://linguistics.as.uky.edu/ling-grad-program) page]"
date: "`r Sys.Date()`"
format:
    html:
      theme: cerulean
