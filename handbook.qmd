...
subtitle: "(draft) Summer 2023^[Find the most recent revision of this document on the [UK Linguistics Graduate Programs](https://linguistics.as.uky.edu/ling-grad-program) page]"
date: "`r Sys.Date()`"
format:
    html:
      theme: cerulean
...
XXX We need to stipulate an actual policy on summer support that includes block funding and teaching opportunities.
...
XXX text still needed about completing the MA thesis.
...
# Ph.D. Program
## Introduction
Introductory text about Ph.D. program.
## Advisor and Thesis Committee
## Coursework Requirements
## Concurrent Degrees
